...
export const EditorData = () => (
  <div>
    <h3>
      Celebal Technologies is a software services company specializing in data science, big data, and enterprise cloud solutions. They help organizations become data-driven by leveraging cutting-edge technologies like AI and machine learning to extract intelligence from data, facilitating smarter and faster decision-making. With a focus on "Data to Intelligence", Celebal Technologies offers tailored solutions for various industries, including manufacturing, retail, energy, and finance, with a strong emphasis on digital innovation and enterprise cloud integration.
      More Details:
      Core Focus:
      Celebal Technologies' core offerings revolve around transforming data into actionable insights, enabling clients to make informed decisions and improve business efficiency.
      Technology Stack:
      They utilize technologies like AI, machine learning, robotics, and low-code platforms to develop solutions for diverse business needs.
      Industry Expertise:
      Celebal Technologies serves a wide range of industries, including manufacturing, retail, energy, healthcare, and financial services.
      Partnerships:
      They are partners with leading technology providers like Microsoft and Databricks, and have received recognition as Microsoft's Country Partner of the Year.
      Global Presence:
      While headquartered in Jaipur, India, Celebal Technologies has a global presence, working with Fortune 1000 companies and other organizations worldwide.
      Digital Transformation:
      They help enterprises adopt a data-driven approach to digital transformation, enhancing customer experience, improving operational efficiency, and ensuring compliance.
      Innovative Solutions:
      Celebal Technologies develops in-house products like supply chain analytics, chatbots, and BI planning tools.
      Employee Growth:
      They emphasize employee growth through mentorship programs, skill development workshops, and leadership training.
    </h3>
  </div>
);
...
export const chatData = [
  {
    image:
      ...
      desc: 'Prerna Kamat sent you new message',
    time: '9:08 AM',
  },
  {
    image:
      avatar3,
      message: 'Vaibhav Jain the Team!',
  ...
  },
  {
    image:
      myavatar,
    message: 'Aakanshi completed tasks',
...
export const scheduleData = [
  ...
  },
  {
    ...
    EndTime: '2021-05-14T08:30:00.000Z',
  ...
  },
  {
    ...
    EndTime: '2021-05-14T05:30:00.000Z',
...
export const kanbanData = [
  {
    ...
    Title: 'Task - 29001',
    Status: 'Open',
    Summary: 'Forms and Form Validation',
    Type: 'Story',
    Priority: 'Low',
  ...
  },
  {
    ...
    Title: 'Task - 29004',
    Status: 'InProgress',
    Summary: 'Resume Building Session with Prerna Kamat',
    Type: 'Bug',
    Priority: 'Critical',
    Tags: 'IE',
    Estimate: 2.5,
  ...
  },
  {
    ...
    Title: 'Task - 29007',
    Status: 'Validate',
    Summary: 'HR Session with Priyanshi Jain',
    Type: 'Improvement',
    Priority: 'Low',
    Tags: 'Validation',
    Estimate: 1.5,
  ...
  },
  {
    ...
    Title: 'Task - 29009',
    Status: 'Review',
    Summary: 'Fix the issues reported in Spotify Clone.',
    Type: 'Bug',
    Priority: 'Critical',
    Tags: 'Fix,Safari',
    Estimate: 1.5,
  ...
  },
  {
    ...
    Title: 'Task - 29010',
    Status: 'Close',
    Summary: 'Test the application in the E commerce',
    Type: 'Story',
    Priority: 'Low',
    Tags: 'Review,IE',
    Estimate: 5.5,
